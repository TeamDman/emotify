...
namespace Emotify.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        private readonly SignInManager<EmotifyUser> _signInManager;
        private readonly UserManager<EmotifyUser> _userManager;
        private readonly IEmailSender _emailSender;
        private readonly ILogger<ExternalLoginModel> _logger;

        public ExternalLoginModel(
            SignInManager<EmotifyUser> signInManager,
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                // var user = info.
                // await _userManager.AddClaimsAsync(user, info.Principal.Claims.AsEnumerable());
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                var user = new EmotifyUser { UserName = Input.Email, Email = Input.Email };
